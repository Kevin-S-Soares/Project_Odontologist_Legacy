...
export class State {
  fetchResponse: Response<BreakTimeSchedules> = new Response();
...
export const View = (props: {
  ...
  return (
    <div>
      ...
      <div>
        <h1 className="mb-4 text-2xl font-bold">Edit Break Time</h1>
      </div>
              ...
              <fieldset>
                <div className="my-2 flex flex-col">
                  ...
                  <select
                    ...
                    value={props.state.fetchResponse.data.breakTime.scheduleId}
                  >
                ...
                <div className="my-2 flex flex-col">
                  ...
                  <input
                    ...
                    value={props.state.fetchResponse.data.breakTime.name}
                ...
                <div className="my-2 flex flex-col">
                  ...
                  <input
                    ...
                    step={1}
                    onChange={props.behavior.changeValue}
                    value={props.state.fetchResponse.data.breakTime.startTime}
                  />
                </div>
                <div className="my-2 flex flex-col">
                  ...
                  <select
                    className="rounded-md border-2 border-slate-300 px-2 py-1"
                    value={props.state.fetchResponse.data.breakTime.startDay}
                    name="startDay"
                    onChange={props.behavior.selectItem}
                  >
                ...
                <div className="my-2 flex flex-col">
                  ...
                  <input
                    className="rounded-md border-2 border-slate-300 px-2 py-1"
                    value={props.state.fetchResponse.data.breakTime.endTime}
                    type="time"
                    name="endTime"
                    step={1}
                    onChange={props.behavior.changeValue}
                ...
                <div className="my-2 flex flex-col">
                  ...
                  <select
                    className="rounded-md border-2 border-slate-300 px-2 py-1"
                    value={props.state.fetchResponse.data.breakTime.endDay}
                    name="endDay"
                    onChange={props.behavior.selectItem}
                  >
                    <option value={0}>Sunday</option>
