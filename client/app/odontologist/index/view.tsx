...
export class State {
  paginationResponse: Response<IPagination<Odontologist>> = new Response();
    ...
    <div>
      <div className="mb-8 flex justify-between">
        <div className="flex">
          <div className="flex">
            <Link
              className="flex w-12 justify-center overflow-hidden whitespace-nowrap rounded-md bg-emerald-500 px-4 py-3 font-bold text-white transition-all hover:w-48 hover:bg-emerald-600 hover:after:content-['_Add_Odontologist']"
              href="./add"
            >
              <span>+</span>
            </Link>
          ...
          <div>
            <Link
              className="mx-2 inline-block rounded-md bg-emerald-500 px-4 py-3 font-semibold text-white transition-all hover:bg-emerald-600"
              href="/schedule/index"
            >
              <span>Verify schedules</span>
            </Link>
          </div>
        </div>
      ...
      props.state.paginationResponse.data !== null ? (
        <div>
          {props.state.paginationResponse.data.page.length <= 0 ? (
            <p>No odontologists available!</p>
          ) : (
            <></>
          )}
          {props.state.paginationResponse.data.page.length > 0 ? (
            <section className="">
              ...
              >
                <div className="col-start-1 col-end-6 grid grid-cols-5 border-b-2 border-black">
